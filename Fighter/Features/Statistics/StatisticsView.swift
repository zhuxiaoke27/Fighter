...
struct StatisticsView: View {
    ...
    private var countersGrid: some View {
        LazyVGrid(columns: [GridItem(.flexible()), GridItem(.flexible())], spacing: 12) {
            statCard(icon: "trophy.fill", color: Theme.energyColor, title: String(localized: "stat_wins"), value: "\(stats.totalWins)")
            statCard(icon: "skull.fill", color: Color(red: 0.85, green: 0.22, blue: 0.18), title: String(localized: "stat_deaths"), value: "\(stats.totalDeaths)")
            statCard(icon: "flame.fill", color: Color(red: 0.90, green: 0.45, blue: 0.20), title: String(localized: "stat_streak"), value: "\(stats.bestWinStreak)")
            statCard(icon: "crown.fill", color: Color(red: 0.95, green: 0.75, blue: 0.20), title: String(localized: "stat_bosses"), value: "\(stats.bossesDefeated)")
            statCard(icon: "coins.fill", color: Theme.energyColor, title: String(localized: "stat_gold"), value: "\(stats.totalGoldEarned)")
            statCard(icon: "gem.fill", color: Color(red: 0.70, green: 0.50, blue: 0.90), title: String(localized: "stat_relics"), value: "\(stats.relicsCollected)")
        }
    }
